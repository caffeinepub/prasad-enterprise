...
export class Backend implements backendInterface {
    ...
    async createBlogAuthor(arg0: Principal, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBlogAuthor(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBlogPost(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async deleteBlogAuthor(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteBlogAuthor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBlogAuthors(): Promise<Array<BlogAuthor>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBlogAuthors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBlogPosts(): Promise<Array<Post>> {
        if (this.processError) {
            try {
    ...
    async getBlogPostsByBlogAuthor(arg0: string): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlogPostsByBlogAuthor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBlogPostsByCategory(arg0: string): Promise<Array<Post>> {
        if (this.processError) {
            try {
    ...
    async getBlogPostsByTag(arg0: string): Promise<Array<Post>> {
        if (this.processError) {
            try {
    ...
    async updateBlogAuthor(arg0: Principal, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBlogAuthor(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBlogPost(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: Array<string>): Promise<void> {
        if (this.processError) {
            try {
